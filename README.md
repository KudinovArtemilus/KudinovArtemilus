...
<p align="left">Я начинающий разработчик. Учусь самостоятельно имею высшее и средне-специальное образование. С июля 2025 года я изучаю разработку исключительно по книгам и по курсам. Буду по этапам заполнять данные. Мой опыт работа с Siemens контоллерами прописывание логики в STEP, TiaPortal.</p>
...
<table>
    ...
    <tr>
     ...
     <tr>
      ...
      <td>август 2025 - Ноябрь 2025</td>
    </tr>
     <tr>
        <td>4 📚 </td>
        <td>Марк Прайс - С# Sharp 10 и .NET 6. Современная кросс-платформенная разработка</td>
      <td>Ноябрь 2025 - Январь 2026</td>
    </tr>
      <tr>
        <td>5 🎓 </td>
        <td>Skillbox - Профессия «Java-разработчик»</td>
      <td>Январь 2026 - по настоящее время</td>
    </tr>
  <tr>
        <td>6 📚 </td>
        <td>Васильев А - Java для всех</td>
      <td>Февраль 2026 - по настоящее время</td>
    </tr>
</table>
